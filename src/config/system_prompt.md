...
- `responder_como_draft`: true si la regla que aplica define `draft: true`. La respuesta se guardará como borrador en Drafts para revisión humana, en lugar de enviarse. Default: false.
